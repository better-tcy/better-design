        ...
        if (BUILD.style && Cstr.style) {
            ...
            if (!styles.has(scopeId)) {
                ...
                if (!BUILD.hydrateServerSide &&
                    ...
                    style = await Promise.resolve().then(function () { return require('./shadow-css-5828cf2a.js'); }).then((m) => m.scopeCss(style, scopeId, false));
                }
